import { FacebookIcon, GithubIcon, Instagram, InstagramIcon, Mail, MapPin, Phone, Send } from "lucide-react";
    ...
    <section id="contact" className="py-24 px-4 relative bg-secondary/30">
      <div className="container mx-auto max-w-5xl">
        ...
        <p className="text-center text-muted-foreground mb-12 max-w-2xl mx-auto">
          Have a project in or mind? Let's work together! I'm always open to discussing new projects, creative ideas, or opportunities to be part of your vision.
        </p>
            ...
            <div className="space-y-6 text-left">
              ...
              <div className="flex items-start space-x-4">
                ...
                <div>
                  ...
                  <a href="telto:+1123456789" className="text-muted-foreground hover:text-primary transition-colors">
                      +123 456 7890
                  </a>
                </div>
              </div>
            ...
            <form action="" className="space-y-6">
              ...
              <div>
                ...
                <input 
                  ...
                  required 
                  className="w-full px-4 py-3 rounded-md border border-input bg-background focus:outline-hidden focus:ring-2 focus:ring-primary"
                  placeholder="kevindkid@gmail.com"
                />
              </div>
              <div>
